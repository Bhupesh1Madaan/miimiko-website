    ...
    useEffect(() => {
        const fetchCourse = async () => {
            try {
                ...
                // Transform curriculum for accordion UI
                ...
                const transformedCourse = {
                    ...
                    stats: [
                        { icon: '📅', value: found.displayDuration, label: 'Duration' },
                        { icon: '📚', value: found.totalSessions, label: 'Total Classes' },
                        { icon: '⏰', value: found.sessionDuration, label: 'Per Session' },
                        { icon: '👨‍🎨', value: `${found.minAge}–${found.maxAge} yrs`, label: 'Age Group' },
                    ],
                    ageGroups: [
                        { emoji: '🎨', range: `${found.minAge}–${found.maxAge} yrs`, label: 'Suitable Age Group' },
                    ],
                    sidebarFeatures: [
                        { icon: '🌐', label: 'Mode', value: found.mode },
                        { icon: '📆', label: 'Schedule', value: found.schedule },
                        { icon: '📅', label: 'Frequency', value: found.frequency },
                        { icon: '🖥️', label: 'Material Required', value: found.materials },
                        { icon: '🎓', label: 'Certificate', value: found.certificate },
                        { icon: '👩‍🏫', label: 'Teachers', value: found.teachers },
                        { icon: '🌍', label: 'Language', value: found.language },
                    ],
            ...
            <section className="course-details-hero">
                <div
                    ...
                    style={{
                        background: course.image
                            ? `url(${course.image}) center/cover`
                            : 'linear-gradient(135deg, #040103 0%, #4a0028 60%, #2a0016 100%)',
                    }}
                />
                <div className="course-details-hero-overlay" />
